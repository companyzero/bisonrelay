...
var file_clientrpc_proto_rawDesc = []byte{
	...
	0x04, 0x52, 0x0a, 0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x22, 0x4e, 0x0a,
	...
	0x65, 0x4d, 0x6f, 0x64, 0x65, 0x52, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x2a, 0x3b, 0x0a, 0x0b, 0x4d,
	...
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x30, 0x01, 0x32, 0x86, 0x02, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74,
...
var file_clientrpc_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_clientrpc_proto_goTypes = []interface{}{
	...
	(*RMPrivateMessage)(nil),       // 15: RMPrivateMessage
	(*RMGroupMessage)(nil),         // 16: RMGroupMessage
}
var file_clientrpc_proto_depIdxs = []int32{
	15, // 0: PMRequest.msg:type_name -> RMPrivateMessage
	15, // 1: ReceivedPM.msg:type_name -> RMPrivateMessage
	16, // 2: GCReceivedMsg.msg:type_name -> RMGroupMessage
	...
	7,  // 7: ChatService.PM:input_type -> PMRequest
	9,  // 8: ChatService.PMStream:input_type -> PMStreamRequest
	5,  // 9: ChatService.AckReceivedPM:input_type -> AckRequest
	11, // 10: ChatService.GCM:input_type -> GCMRequest
	13, // 11: ChatService.GCMStream:input_type -> GCMStreamRequest
	5,  // 12: ChatService.AckReceivedGCM:input_type -> AckRequest
	2,  // 13: VersionService.Version:output_type -> VersionResponse
	4,  // 14: VersionService.KeepaliveStream:output_type -> KeepaliveEvent
	8,  // 15: ChatService.PM:output_type -> PMResponse
	10, // 16: ChatService.PMStream:output_type -> ReceivedPM
	6,  // 17: ChatService.AckReceivedPM:output_type -> AckResponse
	12, // 18: ChatService.GCM:output_type -> GCMResponse
	14, // 19: ChatService.GCMStream:output_type -> GCReceivedMsg
	6,  // 20: ChatService.AckReceivedGCM:output_type -> AckResponse
