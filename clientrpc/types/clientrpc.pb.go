...
var file_clientrpc_proto_rawDesc = []byte{
	...
	0x52, 0x0b, 0x75, 0x6e, 0x61, 0x63, 0x6b, 0x65, 0x64, 0x46, 0x72, 0x6f, 0x6d, 0x22, 0xbb, 0x01,
	...
	0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x43, 0x0a, 0x0e, 0x54,
	0x69, 0x70, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a,
	0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x75, 0x73, 0x65,
	0x72, 0x12, 0x1d, 0x0a, 0x0a, 0x64, 0x63, 0x72, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x01, 0x52, 0x09, 0x64, 0x63, 0x72, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74,
	0x22, 0x11, 0x0a, 0x0f, 0x54, 0x69, 0x70, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0x4e, 0x0a, 0x10, 0x52, 0x4d, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0x3b, 0x0a, 0x0b, 0x4d, 0x65, 0x73, 0x73, 0x61,
	...
	0x74, 0x30, 0x01, 0x32, 0x86, 0x02, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x53, 0x65, 0x72, 0x76,
...
var file_clientrpc_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_clientrpc_proto_goTypes = []interface{}{
	...
	(*RMPrivateMessage)(nil),           // 26: RMPrivateMessage
	(*RMGroupMessage)(nil),             // 27: RMGroupMessage
	(*PostMetadata)(nil),               // 28: PostMetadata
	(*PostMetadataStatus)(nil),         // 29: PostMetadataStatus
	nil,                                // 30: PostMetadata.AttributesEntry
	nil,                                // 31: PostMetadataStatus.AttributesEntry
}
var file_clientrpc_proto_depIdxs = []int32{
	26, // 0: PMRequest.msg:type_name -> RMPrivateMessage
	26, // 1: ReceivedPM.msg:type_name -> RMPrivateMessage
	27, // 2: GCReceivedMsg.msg:type_name -> RMGroupMessage
	19, // 3: ReceivedPost.summary:type_name -> PostSummary
	28, // 4: ReceivedPost.post:type_name -> PostMetadata
	29, // 5: ReceivedPostStatus.status:type_name -> PostMetadataStatus
	0,  // 6: RMPrivateMessage.mode:type_name -> MessageMode
	0,  // 7: RMGroupMessage.mode:type_name -> MessageMode
	30, // 8: PostMetadata.attributes:type_name -> PostMetadata.AttributesEntry
	31, // 9: PostMetadataStatus.attributes:type_name -> PostMetadataStatus.AttributesEntry
	...
	15, // 18: PostsService.SubscribeToPosts:input_type -> SubscribeToPostsRequest
	17, // 19: PostsService.UnsubscribeToPosts:input_type -> UnsubscribeToPostsRequest
	20, // 20: PostsService.PostsStream:input_type -> PostsStreamRequest
	5,  // 21: PostsService.AckReceivedPost:input_type -> AckRequest
	22, // 22: PostsService.PostsStatusStream:input_type -> PostsStatusStreamRequest
	5,  // 23: PostsService.AckReceivedPostStatus:input_type -> AckRequest
	24, // 24: PaymentsService.TipUser:input_type -> TipUserRequest
	2,  // 25: VersionService.Version:output_type -> VersionResponse
	4,  // 26: VersionService.KeepaliveStream:output_type -> KeepaliveEvent
	8,  // 27: ChatService.PM:output_type -> PMResponse
	10, // 28: ChatService.PMStream:output_type -> ReceivedPM
	6,  // 29: ChatService.AckReceivedPM:output_type -> AckResponse
	12, // 30: ChatService.GCM:output_type -> GCMResponse
	14, // 31: ChatService.GCMStream:output_type -> GCReceivedMsg
	6,  // 32: ChatService.AckReceivedGCM:output_type -> AckResponse
	16, // 33: PostsService.SubscribeToPosts:output_type -> SubscribeToPostsResponse
	18, // 34: PostsService.UnsubscribeToPosts:output_type -> UnsubscribeToPostsResponse
	21, // 35: PostsService.PostsStream:output_type -> ReceivedPost
	6,  // 36: PostsService.AckReceivedPost:output_type -> AckResponse
	23, // 37: PostsService.PostsStatusStream:output_type -> ReceivedPostStatus
	6,  // 38: PostsService.AckReceivedPostStatus:output_type -> AckResponse
	25, // 39: PaymentsService.TipUser:output_type -> TipUserResponse
